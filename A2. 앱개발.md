...
> A1 Phase 7. **현재 미구현** — 인코더·태그·아트워크·OfflineAudioContext 배치 렌더 전부 신규. Phase 0~6 중 가장 신규 코드량이 크고(인코더 라이브러리·Electron 파일 IO·오프라인 DSP 재현) 외부 의존성·결정사항이 있어, 아래 순서로 단계 분할해 진행한다.
