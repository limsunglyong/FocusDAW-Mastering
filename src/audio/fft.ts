// FocusDAW Mastering Desk v0.2.24 (Phase 2) - Radix-2 Cooley-Tukey FFT
// _refer/FocusSpectogram/src/audio/fft.ts 이식. 외부 의존성 없이 경량 구현.
// 고정 크기에 대해 bit-reversal/twiddle을 사전계산해 프레임 반복 시 재사용한다.
