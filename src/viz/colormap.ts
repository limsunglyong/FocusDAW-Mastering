// FocusDAW Mastering Desk v0.2.26 (Phase 2) - 히트맵 컬러맵
// _refer/FocusSpectogram/src/viz/colormap.ts verbatim 이식("원본 그대로" 요청).
// 정규화된 값 t∈[0,1] → RGB(0..1). deep navy → emerald → gold → light.
